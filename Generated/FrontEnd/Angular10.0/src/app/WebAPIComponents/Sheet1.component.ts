...
export class Sheet1Component implements OnInit {
  ...
  displayedColumns: string[] = ['rowIndex' , 'noticeno','contractobject','contractingauthority','supplier','contractvalue','currency','cpvcode','noticetype','procedurestate','awardstate','county','communityreference','publicationdate', 'operations'];
  ...
  public deleteData(id: number): void{
    ...
    // const ndx = this.rows.findIndex(it=>it.id == idDeleted);
      ...
      const ndx = this.rows.findIndex(it => it.id20200909002008 === idDeleted);
