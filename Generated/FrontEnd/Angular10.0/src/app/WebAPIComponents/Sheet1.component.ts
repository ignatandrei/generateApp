...
export class Sheet1Component implements OnInit {
  ...
  displayedColumns: string[] = ['noticeno','contractobject','contractingauthority','supplier','contractvalue','currency','cpvcode','noticetype','procedurestate','awardstate','county','communityreference','publicationdate', 'operations'];
