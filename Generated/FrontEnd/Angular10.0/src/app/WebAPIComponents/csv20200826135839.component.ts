...
@Component({
  selector: 'app-csv20200826135839-component',
  templateUrl: './csv20200826135839.component.html',
  styleUrls: ['./csv20200826135839.component.css']
})
export class csv20200826135839Component implements OnInit {

  displayedColumns: string[] = ['firstname','lastname', 'operations'];
  dataSource: MatTableDataSource<csv20200826135839>;
  ...
  public rows:csv20200826135839[]=[];
  constructor(private mainService: csv20200826135839Service, private router: Router ) { }
  ...
  public add(): void{
    this.router.navigate(["/csv20200826135839/add"]);
    return;
  }
