...
namespace TestWebAPI.Controllers
{
    ...
    public class Sheet2Controller : ControllerBase
    {
        ...
        public Sheet2Controller(IRepository<Sheet2> repository)
        {
        ...
        // GET: api/Sheet2/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Sheet2>> Get(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(long id, Sheet2 record)
        {
            if (id != record.ID)
            {
                return BadRequest();
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<ActionResult<Sheet2>> Insert(Sheet2 record)
        {
