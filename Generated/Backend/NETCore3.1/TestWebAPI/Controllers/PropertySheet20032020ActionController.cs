...
namespace TestWebAPI.Controllers
{
    ...
    [ApiController]
    public class PropertySheet20032020Controller : ControllerBase
    {
        private readonly IRepository<PropertySheet20032020> _repository;

        public PropertySheet20032020Controller(IRepository<PropertySheet20032020> repository)
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<PropertySheet20032020>> Get(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<PropertySheet20032020>> Put(long id, PropertySheet20032020 record)
        {
            if (id != record.id)
            {
                return BadRequest();
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<PropertySheet20032020> Insert(PropertySheet20032020 record)
        {
