...
namespace TestWebAPI.Controllers
{
    ...
    [ApiController]
    public class Ani12_14Controller : ControllerBase
    {
        private readonly IRepository<Ani12_14> _repository;

        public Ani12_14Controller(IRepository<Ani12_14> repository)
        {
        ...
        // GET: api/Ani12_14/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Ani12_14>> Get(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(long id, Ani12_14 record)
        {
            if (id != record.ID)
            {
                return BadRequest();
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<ActionResult<Ani12_14>> Insert(Ani12_14 record)
        {
