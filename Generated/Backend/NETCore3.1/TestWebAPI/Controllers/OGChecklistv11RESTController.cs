...
namespace TestWebAPI.Controllers
{
    ...
    [ApiController]
    public class REST_OGChecklistv11Controller : ControllerBase
    {
        private readonly IRepository<OGChecklistv11,long> _repository;

        public REST_OGChecklistv11Controller(IRepository<OGChecklistv11,long> repository)
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<OGChecklistv11>> FindAfterId(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<OGChecklistv11>> Update(long id, OGChecklistv11 record)
        {
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<OGChecklistv11> Post(OGChecklistv11 record)
        {
