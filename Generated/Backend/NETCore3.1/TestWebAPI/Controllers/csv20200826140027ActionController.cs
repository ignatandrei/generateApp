...
namespace TestWebAPI.Controllers
{
    ...
    [ApiController]
    public class csv20200826140027Controller : ControllerBase
    {
        private readonly IRepository<csv20200826140027> _repository;

        public csv20200826140027Controller(IRepository<csv20200826140027> repository)
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<csv20200826140027>> Get(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<csv20200826140027>> Put(long id, csv20200826140027 record)
        {
            if (id != record.ID)
            {
                return BadRequest();
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<csv20200826140027> Insert(csv20200826140027 record)
        {
