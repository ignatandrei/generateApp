...
namespace TestWebAPI.Controllers
{
    ...
    public class MyDataController : ControllerBase
    {
        ...
        public MyDataController(IRepository<MyData> repository)
        {
        ...
        // GET: api/MyData/5
        [HttpGet("{id}")]
        public async Task<ActionResult<MyData>> Get(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<MyData>> Put(long id, MyData record)
        {
            if (id != record.ID)
            {
                return BadRequest();
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<MyData> Insert(MyData record)
        {
