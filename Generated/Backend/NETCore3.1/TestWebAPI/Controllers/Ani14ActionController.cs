...
namespace TestWebAPI.Controllers
{
    ...
    [ApiController]
    public class Ani14Controller : ControllerBase
    {
        private readonly IRepository<Ani14> _repository;

        public Ani14Controller(IRepository<Ani14> repository)
        {
        ...
        // GET: api/Ani14/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Ani14>> Get(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(long id, Ani14 record)
        {
            if (id != record.ID)
            {
                return BadRequest();
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<ActionResult<Ani14>> Insert(Ani14 record)
        {
