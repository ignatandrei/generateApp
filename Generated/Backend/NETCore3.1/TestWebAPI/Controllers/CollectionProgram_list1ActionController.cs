...
namespace TestWebAPI.Controllers
{
    ...
    [ApiController]
    public class CollectionProgram_list1Controller : ControllerBase
    {
        private readonly IRepository<CollectionProgram_list1> _repository;

        public CollectionProgram_list1Controller(IRepository<CollectionProgram_list1> repository)
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<CollectionProgram_list1>> Get(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<CollectionProgram_list1>> Put(long id, CollectionProgram_list1 record)
        {
            if (id != record.ID)
            {
                return BadRequest();
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<CollectionProgram_list1> Insert(CollectionProgram_list1 record)
        {
