...
namespace TestWebAPI.Controllers
{
    ...
    [ApiController]
    public class Ani10_12Controller : ControllerBase
    {
        private readonly IRepository<Ani10_12> _repository;

        public Ani10_12Controller(IRepository<Ani10_12> repository)
        {
        ...
        // GET: api/Ani10_12/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Ani10_12>> Get(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(long id, Ani10_12 record)
        {
            if (id != record.ID)
            {
                return BadRequest();
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<ActionResult<Ani10_12>> Insert(Ani10_12 record)
        {
