...
namespace TestWebAPI.Controllers
{
    ...
    [ApiController]
    public class REST_csv20200826135839Controller : ControllerBase
    {
        private readonly IRepository<csv20200826135839> _repository;

        public REST_csv20200826135839Controller(IRepository<csv20200826135839> repository)
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<csv20200826135839>> FindAfterId(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<csv20200826135839>> Update(long id, csv20200826135839 record)
        {
            if (id != record.ID)
            {
                return BadRequest();
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<csv20200826135839> Post(csv20200826135839 record)
        {
