...
namespace TestWebAPI.Controllers
{
    ...
    [ApiController]
    public class Ani8_10Controller : ControllerBase
    {
        private readonly IRepository<Ani8_10> _repository;

        public Ani8_10Controller(IRepository<Ani8_10> repository)
        {
        ...
        // GET: api/Ani8_10/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Ani8_10>> Get(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(long id, Ani8_10 record)
        {
            if (id != record.ID)
            {
                return BadRequest();
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<ActionResult<Ani8_10>> Insert(Ani8_10 record)
        {
