...
namespace TestGenerate
{
    public class TestGenerateSqlServer
    {
        ...
        static GenerateAppV1 gen()
        {
            ...
            t[1].table.fields = new List<Field>();
            t[1].table.fields.Add(new Field() { name = "id" });
            t[1].table.fields.Add(new Field() { name = "A2" });
            t[1].table.fields.Add(new Field() { name = "A3" });
            t[1].table.fields.Add(new Field() { name = "A4" });
            t[1].table.fields.Add(new Field() { name = "A5" });
            t[1].table.fields.Add(new Field() { name = "A6" });
            t[1].table.fields.Add(new Field() { name = "A7" });
            t[1].table.fields.Add(new Field() { name = "A8" });
            t[1].table.fields.Add(new Field() { name = "A9" });
            t[1].table.fields.Add(new Field() { name = "A10" });
            t[1].table.fields.Add(new Field() { name = "A11" });
            t[1].table.fields.Add(new Field() { name = "A12" });
            t[1].table.fields.Add(new Field() { name = "A13" });
            t[1].table.fields.Add(new Field() { name = "A14" });
            t[1].table.fields.Add(new Field() { name = "A15" });
            t[1].table.fields.Add(new Field() { name = "A16" });
            t[1].table.fields.Add(new Field() { name = "A17" });
            t[1].table.fields.Add(new Field() { name = "A18" });
            t[1].table.fields.Add(new Field() { name = "A19" });
            t[1].table.fields.Add(new Field() { name = "A20" });
            t[1].table.fields.Add(new Field() { name = "A21" });
            t[1].table.fields.Add(new Field() { name = "A22" });
            t[1].table.fields.Add(new Field() { name = "A23" });
            t[1].table.fields.Add(new Field() { name = "A24" });
            t[1].table.fields.Add(new Field() { name = "A25" });
            t[1].table.fields.Add(new Field() { name = "A26" });
            t[1].table.fields.Add(new Field() { name = "A27" });
            t[1].table.fields.Add(new Field() { name = "A28" });
            t[1].table.fields.Add(new Field() { name = "A29" });
            t[1].table.fields.Add(new Field() { name = "A30" });
            t[1].table.fields.Add(new Field() { name = "A31" });
            t[1].table.fields.Add(new Field() { name = "A32" });
            t[1].table.fields.Add(new Field() { name = "A33" });
            t[1].table.fields.Add(new Field() { name = "A34" });
